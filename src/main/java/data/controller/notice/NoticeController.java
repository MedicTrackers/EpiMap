...
public class NoticeController {
    ...
    public String list(@RequestParam(value= "pageNum",defaultValue = "1")int pageNum,Model model)
    {
        ...
        List<NoticeDto> list=null; //페이징에 필요한 데이타

        totalCount=noticeService.getTotalCount();//총 글갯수
        ...
        list=noticeService.getPagingList(startNum, perPage);
